...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val handler = Handler()
        var delayMillis = 90L // Update snake position
...
//
            ...
            fun checkFoodCollision() {
                ...
                if (distance < distanceThreshold) { // Check if the distance between the snake head and the meat is less than the threshold
                    ...
                    // Inside checkFoodCollision() function
                    if (scorex > highScore) {
                        highScore = scorex
...
//  update the currentDirection variable when pressed
            ...
            playagain.setOnClickListener {
                val intent = Intent(this,Activity_highscore::class.java)
